...
moving beyond it.\\
    ...
    \subsubsection{Future Tasks and Challenges}

    \noindent \textbf{Build Popular Power:} The main challenge is to
decentralize government so that
\textbf{``the real power is with the people''}. Revolutions are understood
to be made by people through their organizations, not by governments.\\

    \noindent \textbf{Counter the Far-Right:}
    \begin{itemize}
        \item Far-right paramilitary groups (e.g., Santa Cruz Civic
        Committee) have not been dismantled and continue to use threats and
        violence.
        \item Ending impunity for these groups is a key task for the new
        administration.
    \end{itemize}

    \noindent \textbf{Strengthen International Solidarity:} The need to
rebuild regional organizations like ALBA and UNASUR is critical to defend
against foreign intervention.\\

    \noindent \textbf{Media and Information:} Independent media and social
media were crucial in countering the corporate narrative during the coup. A
future task is to restructure the media to support popular emancipation.\\

    \noindent \textbf{Immediate Goals:} Protect the new government, defend
the `process of change', and rebuild the economy for the benefit of the people.
